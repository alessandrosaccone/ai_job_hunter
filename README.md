...
Each job appears as a **single collapsible row** showing only **title and match score** (e.g. `Software Engineer — 8.2/10`). Click it to open the full card with company, location, and nested sections:

| Section (inside the card) | Contents |
|---------------------------|----------|
| **RAL — …** | Salary summary in the sub-title; details, research notes, **Modifica RAL** |
| **Che CV inviare?** | Application channel and CV tips |
| **Motivazione AI** | Full AI reasoning |

**Apri annuncio** and **Salva candidatura** are at the bottom of the expanded card.
...
Ogni lavoro compare come **riga collassata** con solo **titolo e punteggio** (es. `Software Engineer — 8.2/10`). Cliccala per aprire la card completa con azienda, sede e sottosezioni:

| Sezione (dentro la card) | Contenuto |
|--------------------------|-----------|
| **RAL — …** | RAL nel sottotitolo; dettagli, note ricerca, **Modifica RAL** |
| **Che CV inviare?** | Canale candidatura e consigli CV |
| **Motivazione AI** | Motivazione completa dell'AI |

**Apri annuncio** e **Salva candidatura** sono in fondo alla card espansa.
